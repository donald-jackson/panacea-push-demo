 ...
 */
	Configure::write('Security.salt', 'fsdfds-8fdsfj24f4kfjsfjdslkfdsfdsfds');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '5324632464576457457427565353215');
