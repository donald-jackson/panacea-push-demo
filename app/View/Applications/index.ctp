					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Application'), array('action' => 'add'), array('escape' => false)); ?></li>
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('application_key'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($applications as $application): ?>
					<tr>
						...
						<td><?php echo h($application['Application']['type']); ?>&nbsp;</td>
						<td><?php echo h($application['Application']['api_key']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($application['Account']['username'], array('controller' => 'accounts', 'action' => 'view', $application['Account']['id'])); ?>
		</td>
						<td><?php echo h($application['Application']['application_key']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $application['Application']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $application['Application']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $application['Application']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $application['Application']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
